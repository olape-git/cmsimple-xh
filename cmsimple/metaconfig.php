...
$mcf['site']['admin-template']="function:XH_adm_tpl";
$mcf['site']['xhBoard-StartPosition']="enum:XH-Classic,xhBoard-Center,xhBoard-Right,xhBoard-Left";
...
$mcf['editmenu']['admin-menu-hidden']="bool";
