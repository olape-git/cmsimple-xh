...
/**
 * Provides a slide effect: slideUp | slideDown | slideToggle
...
/**
 * Toggle button to show or hide the debug messages.
 *
 * To do: Vanilla JS
 *
 * @since 1.8
 */
$('#xhShowDebugMsg').click(function () {
    $('#xhShowDebugMsg').toggleClass('xhDebugMsgHide xhDebugMsgShow');
    slideToggle(document.getElementById('xhDebugWarnings'), 300);
});
